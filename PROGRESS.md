...
- **Deployed**: structural palette viewer LIVE at https://spacepixelrts.pages.dev/town-center-structural-viewer?ui=0&view=front-3q&stage=4&pass=palette (200 OK); interactive mode (`70b542d`) adds drag-orbit / wheel-zoom / right-drag-pan + Stage/View/Pass buttons. The in-game Town Center is still a 2D sprite billboard; 3D integration = the next staged piece (renderer pipeline change; Wave A still awaits user sign-off).
